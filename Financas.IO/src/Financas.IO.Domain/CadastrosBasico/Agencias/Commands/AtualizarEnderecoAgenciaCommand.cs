...
{
    public class AtualizarEnderecoAgenciaCommand : Command    
    {
        public AtualizarEnderecoAgenciaCommand(Guid id, string logradouro, string numero, string complemento, string bairro, 
